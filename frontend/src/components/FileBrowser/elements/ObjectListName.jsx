...
//         <>
//             <Tooltip
//                 // ИСПРАВЛЕНО: Срезаем символ, только если это папка И имя действительно заканчивается на слэш
//                 title={object.folder && object.name.endsWith('/') ? object.name.slice(0, -1) : object.name}
//                 placement="bottom"
//                 arrow
//                 enterDelay={700}
//
...
//                 >
//                     {/* ИСПРАВЛЕНО: Срезаем символ, только если это папка И имя действительно заканчивается на слэш */}
//                     {object.folder && object.name.endsWith('/') ? object.name.slice(0, -1) : object.name}
//                 </Typography>
//             </Tooltip>
//
//
