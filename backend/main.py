...
from backend.auth.exception import BaseAppException
from backend.auth.providers import AdaptersProvider, InfrastructureProvider
from backend.auth.router import router as user_router
from backend.storage.providers import StorageProvider
...
async def _base_app_exception_handler(request: Request, exc: BaseAppException):
    """
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(BaseAppException, _base_app_exception_handler)
    app.add_exception_handler(StarletteHTTPException, _base_app_exception_handler)
